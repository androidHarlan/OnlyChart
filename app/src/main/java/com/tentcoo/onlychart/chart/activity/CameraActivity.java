...
import com.tentcoo.onlychart.chart.video.camera.CameraManager;
import com.tentcoo.onlychart.chart.video.camera.CameraProgressBar;
import com.tentcoo.onlychart.chart.video.camera.CameraView;
import com.tentcoo.onlychart.chart.video.camera.MediaPlayerManager;
import com.tentcoo.onlychart.chart.video.utils.FileUtils;
    ...
    protected void initDatas() {
        ...
        mProgressbar.setOnProgressTouchListener(new CameraProgressBar.OnProgressTouchListener() {
            ...
            public void onLongClick(CameraProgressBar progressBar) {
                ...
                isRecording = true;
                Observable.interval(100, TimeUnit.MILLISECONDS).take(max)
