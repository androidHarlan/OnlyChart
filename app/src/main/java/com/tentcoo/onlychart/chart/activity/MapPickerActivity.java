...
import com.tentcoo.onlychart.chart.adapter.MapPickerAdapter;
                ...
                mBaiduMap.snapshotScope(rect, new BaiduMap.SnapshotReadyCallback() {
                    ...
                    public void onSnapshotReady(Bitmap bitmap) {
                        if (null != bitmap && null != conv) {
                            ...
                            Toast.makeText(JGApplication.context, JGApplication.context.getString(R.string.send_location_error),
