...
import com.tentcoo.onlychart.chart.utlis.ViewHolder;
import com.tentcoo.onlychart.chart.widget.MyImageView;
        ...
        ll_document.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (content.getLocalPath() == null) {
                    EventBus.getDefault().postSticky(item.getMessage());
